...
var canvastestvue_type_script_lang_ts_default_1 = /*#__PURE__*/function (_Vue) {
  ...
  Object(createClass["a" /* default */])(default_1, [{
    ...
    value: function mounted() {
      ...
      canvas.installEditPolicy(new draw2d_default.a.policy.connection.DragConnectionCreatePolicy({
        createConnection: function createConnection() {
          ...
          var c = new draw2d_default.a.Connection();
          ...
          c.add(label, new draw2d_default.a.layout.locator.PolylineMidpointLocator());
    ...
    value: function startPointCircle(canvas) {
      ...
      waku.addPort(outputPort, new draw2d_default.a.layout.locator.BottomLocator());
...
var canvastestvue_type_style_index_0_id_06d92b08_scoped_true_lang_css_ = __webpack_require__(1029);
